        ...
        <div className={classes.loginContainer}>
            <div className={classes.formWrapper}>
                <div className={classes.buttonsWrap}>
                    <button className={classNames({[classes.active]: isLogin})} onClick={() => history.push('login')}>Sign in</button>
                    <button className={classNames({[classes.active]: !isLogin})} onClick={() => history.push('register')}>Sign up</button>
                </div>
                ...
                <form style={{marginTop: '20px'}} onSubmit={(event) => handleSubmit(event)}>
                    ...
                    <div className={classes.submitButtonWrap}>
                        <button className={classes.submitButton} type="submit">{isLogin ? <p>Sign in</p> : <p>Sign up</p>}</button>
                    </div>
                </form>
            </div>
        </div>
